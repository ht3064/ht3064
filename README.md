...
|---------------|---------------|---------------------|----------------------------------|
| cherrypic (pickle 후속) | 2025.06 ~ 진행중 | <a href="https://github.com/cherrypic-proj">AI기반 차세대 갤러리 서비스 </a> | Backend Leader + DevOps |
| popi | 2025.04 ~ 2025.06 | <a href="https://github.com/popi-official">LiDAR 카메라 기반 무인 팝업스토어 관리·이용 서비스 </a> | Backend Leader + DevOps |
